...
void kennzahl_abfrage() {
    ...
    input_value(entwaesserungskosten, "Geben Sie die Gesamtkosten fuer Abwasser in Euro an (Beispiel 39.99): ");
    std::cout << "Abwasserkosten in Euro = " << entwaesserungskosten << "\n";
